 ...
 * @contributor kenji
 */
public class RecrawlDataSchemaBase {
    ...
    protected byte[] COLUMN_FAMILY = DEFAULT_COLUMN_FAMILY;
    
    public static final byte[] COLUMN_NOCRAWL = Bytes.toBytes("z");
    
    private boolean useCanonicalString = true;
    ...
    public void setColumnFamily(String colf) {
        COLUMN_FAMILY = Bytes.toBytes(colf);
    }
    ...
    public String getColumnFamily() {
        return Bytes.toString(COLUMN_FAMILY);
    }
